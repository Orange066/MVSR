...
parser.add_argument("--iter", type=int, default=129999)
...
gt_path = '../GARS/GTAV_720_HLBIC_FR_MVRs_NVRs/LR/x4/'
...
file_txt=open(os.path.join(args.result_path, 'gtav.txt'),mode='w')
